  ...
  return (
    <footer className="footer">
      <div className="container">
        ...
        <a href="https://www.linkedin.com/in/dev-cracks/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
          <LinkedInIcon />
        </a>
        <a href="https://hotmart.com/club/dev-cracks" target="_blank" rel="noreferrer" aria-label="Hotmart">
          <HotmartIcon />
        </a>
