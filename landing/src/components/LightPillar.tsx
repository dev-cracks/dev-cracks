...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('Error al crear el renderer WebGL:', error);
      setWebGLSupported(false);
      return;
    }
    ...
    const fragmentShader = `
      ...
      // Aplicar deformación de onda en capas a la posición
      ...
      // Mezcla suave polinomial entre dos valores
      ...
      void main() {
        ...
        // Aplicar rotación 2D a las coordenadas UV
        ...
        for(float i = 0.0; i < 100.0; i++) {
          ...
          // Aplicar escalado vertical y deformación de onda
          vec3 deformed = pos;
          deformed.y *= uPillarHeight;
          deformed = applyWaveDeformation(deformed + vec3(0.0, uTime, 0.0), uTime);
          
          // Calcular campo de distancia usando patrón coseno
          vec2 cosinePair = cos(deformed.xz);
          float fieldDistance = length(cosinePair) - 0.2;
          
          // Restricción de límite radial
        ...
        // Normalizar por ancho del pilar para mantener brillo consistente independientemente del tamaño
        float widthNormalization = uPillarWidth / 3.0;
        color = tanh(color * uGlowAmount / widthNormalization);
        
        // Agregar ruido post-procesamiento
    ...
    // Interacción con el mouse - throttled para rendimiento
