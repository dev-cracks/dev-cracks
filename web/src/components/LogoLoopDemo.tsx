...
namespace LogoLoopDemoModule {
  // SVGs de las tecnologías según el ejemplo
  const ReactIcon = () => (
  ...
  const techLogos = [
    ...
    { node: <DockerIcon />, title: "Docker", href: "https://www.docker.com" },
    { node: <PrismaIcon />, title: "Prisma", href: "https://www.prisma.io" },
    { node: <SupabaseIcon />, title: "Supabase", href: "https://supabase.com" },
    { node: <StripeIcon />, title: "Stripe", href: "https://stripe.com" },
  ];

  export const Component = () => {
    return (
      <section style={{ padding: '60px 0', background: 'linear-gradient(180deg, rgba(13, 17, 23, 0) 0%, rgba(22, 27, 34, 0.5) 100%)' }}>
...
export const LogoLoopDemo = LogoLoopDemoModule.Component;
